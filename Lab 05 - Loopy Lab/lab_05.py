...
# 5 extra 5 to accommodate for spaces between boxes, multiplied to encompass entire section
...
def draw_section_2():
    ...
    for row in range(30):
        for column in range(30):
            ...
            y = 5 + row * 10  # Instead of zero, calculate the proper y location using 'row'
            if column % 2 != 0:  # selecting for every other column with if statement
...
def draw_section_3():
    ...
    for row in range(30):
        for column in range(30):
            ...
            y = 5 + row * 10  # Instead of zero, calculate the proper y location using 'row'
            if row % 2 != 0:  # selecting for every other row with if statement
                arcade.draw_rectangle_filled(x, y, 5, 5, arcade.color.BLACK)
            else:
                arcade.draw_rectangle_filled(x, y, 5, 5, arcade.color.WHITE)
...
def draw_section_4():
    ...
    for row in range(30):
        for column in range(30):
            ...
            y = 5 + row * 10  # Instead of zero, calculate the proper y location using 'row'
            if row % 2 == 0 and column % 2 == 0:  # selecting for every other colum with if statement
                arcade.draw_rectangle_filled(x, y, 5, 5, arcade.color.WHITE)
            else:
                arcade.draw_rectangle_filled(x, y, 5, 5, arcade.color.BLACK)
